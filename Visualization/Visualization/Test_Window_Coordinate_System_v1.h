/**
*Test_Window_Coordinate_System_v1.h
*Purpose:
...
namespace Test
{
	...
	*/
	...
	class Test_Window_Coordinate_System_v1 : public NB_Window
	{
	public:
		//The Buttons are constructed in the window
		Test_Window_Coordinate_System_v1()
			:NB_Window(400, 400, "Coordinate Test v1"),
